...
@pytest.mark.parametrize(
    ...
    [
        ("awesome new title", "awesome new content", True, "Animals"),
        ("favorite pizza", "i love pepperoni", False, "Food"),
        ("tallest skyscrapers", "wahoo", True, "Architecture"),
    ],
)
def test_create_post(
    authorized_client, test_user, test_posts, title, content, published, category
):
...
def test_create_post_default_published_true(authorized_client, test_user, test_posts):
    ...
    assert created_post.content == "abitrary content"
    assert created_post.published == True
    assert created_post.owner_id == test_user["id"]
    assert created_post.category == "arbitrary category"
